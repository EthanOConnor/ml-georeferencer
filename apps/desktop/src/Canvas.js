...
const Canvas = ({ imageData, overlayTransform, onClickImage, onMouseMove, points = [], metersPerPixel, showCrosshair = false, ...props }) => {
    ...
    return (_jsx("div", { ref: containerRef, style: { width: '100%', height: '100%' }, onMouseUp: handleMouseUp, children: _jsx("canvas", { ref: canvasRef, style: { width: '100%', height: '100%', background: '#000', cursor: 'crosshair' }, onMouseMove: handleMouseMove, onMouseDown: handleMouseDown, onWheel: handleWheel, onClick: handleClick, ...props }) }));
};
